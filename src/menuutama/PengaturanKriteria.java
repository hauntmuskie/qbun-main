...
public class PengaturanKriteria extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        judul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/image (7).png"))); // NOI18N
        ...
        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Prioritas Kepentingan dari Kriteria", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        cbKriteria1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Harga", "Mesin/CC", "Irit Bensin", "Desain" }));

        cbKriteria2.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        cbKriteria2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Harga", "Mesin/CC", "Irit Bensin", "Desain" }));
        ...
        cbKriteria3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Harga", "Mesin/CC", "Irit Bensin", "Desain" }));

        cbKriteria4.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        cbKriteria4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Harga", "Mesin/CC", "Irit Bensin", "Desain" }));
