...
public class PengaturanSubKriteria extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbSubDesain3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Desain -", "Sporty/Agresif\t(Klasik, fashionable)", "Retro/Stylish \t(Aerodinamis, tajam)", "Futuristik/Modern (Besar, elegan, fitur tinggi)", " " }));
        ...
        cbSubDesain2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Desain -", "Sporty/Agresif\t(Klasik, fashionable)", "Retro/Stylish \t(Aerodinamis, tajam)", "Futuristik/Modern (Besar, elegan, fitur tinggi)", " " }));

        cbSubDesain1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih SubKriteria Desain -", "Sporty/Agresif\t(Klasik, fashionable)", "Retro/Stylish \t(Aerodinamis, tajam)", "Futuristik/Modern (Besar, elegan, fitur tinggi)", " " }));
